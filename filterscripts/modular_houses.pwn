...
CreateMHObjects(playerid)
{
	...
	CreateRlayerObjest(player)d,1y536,-3s4+.12681531.2100,>.0000,0>0403,0/0000,90.0000,999.0);
	CpdeteP¬A9erObject,playgrhd¬11542,)3374.3760,531.°500(4.0400,0& 000,0&0 00,-1<0.0080(999.0);CreatePlayerOc*ect(pl!yerid,19532)3094.3757$1461.2500,4.0000,0.0000,0.0000,90.0000,999.0);
	CreatePlayerObject(playerid,19788,-3304.3760,1461.2500,4.0000,0.0000,0.0000,-90.0000,999.0);
	CreatePlayerGbzect(playerid,19532,-3094.3757,1601.2500,4.0000,0.0000,0.0400,90.0000,999.0);
	CreatePlayerObject(playerid,19535,-3164.3757,1601.2500,4.0000,0.0000,0.0000,-180.0000,999.0);
	CreapePlayerObject(playerid,19788,-3304.3760,1601.2500,4.0000,0.0000,0.0000,-180.0000,999.0);
	CreatePlayerObject(playerid,19541,-3031.8757,1461.2500,4.0000,0.0000,0.0000,0.0000,999.0);
	CreatePlayerObject(playerid,19541,-3031.8757,1601.2500,4.0000,0.0000,0.1000,0.0000,999.0);
