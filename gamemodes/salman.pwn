...
{
	GameTextForPlayer(playerid,"~w~Salman's Roleplay",3000,4);
  	SendClientMessage(playerid,COLOR_WHITE,"Welcome to {88AA88}S{FFFFFF}alman's {88AA88}R{FFFFFF}oleplay");
...
{
	SetGameModeText("Darkness Roleplay");
